	...
	implements DmSingleSelect<LAYER>
{
	...
	private GeoJsfServiceFactory<L,D,CATEGORY,SERVICE,LAYER,MAP,VIEW,VP,DS,SLDTEMPLATE,SLDTYPE> fMapLayer;
    ...
    public static <L extends UtilsLang,
					...
					SLDTYPE extends UtilsStatus<SLDTYPE,L,D>,
					SLDTEMPLATE extends GeoJsfSldTemplate<L,D,SLDTEMPLATE,SLDTYPE>>
    	GeoJsfMapHelper<L,D,CATEGORY,SERVICE,LAYER,MAP,VIEW,VP,DS,SLDTEMPLATE,SLDTYPE>
    	factory(final Class<SERVICE> clService,MAP view)
    {
    	GeoJsfMapHelper<L,D,CATEGORY,SERVICE,LAYER,MAP,VIEW,VP,DS,SLDTEMPLATE,SLDTYPE> gjm = new GeoJsfMapHelper<L,D,CATEGORY,SERVICE,LAYER,MAP,VIEW,VP,DS,SLDTEMPLATE,SLDTYPE>(clService);
    	gjm.setMap(view);
