...
{		
	...
	<W extends EjbWithSldRules<L,D,G,GT,FS,SLDTEMPLATE,SLDTYPE,SLD,RULE>> RULE save(Class<W> cW, W entity, RULE rule) throws UtilsLockingException, UtilsConstraintViolationException;
	<W extends EjbWithSldRules<L,D,G,GT,FS,SLDTEMPLATE,SLDTYPE,SLD,RULE>> void rm(Class<W> cW, W entity, RULE rule) throws UtilsLockingException, UtilsConstraintViolationException;
}