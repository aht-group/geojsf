...
extends UINamingContainer implements ClientBehaviorHolder
{
	...
	private Map<L,D,G,GT,GS,CATEGORY,SERVICE,LAYER,MAP,SCALE,VIEW,VP,DS,SLDTEMPLATE,SLDTYPE,SLD,RULE> map;
...
//	private ArrayList<GeoJsfService> timeLayers = (ArrayList<GeoJsfService>) ((Map) this.getParent()).getServiceList();
	...
	{
		map = (Map<L,D,G,GT,GS,CATEGORY,SERVICE,LAYER,MAP,SCALE,VIEW,VP,DS,SLDTEMPLATE,SLDTYPE,SLD,RULE>) findComponent("testForm:map");
