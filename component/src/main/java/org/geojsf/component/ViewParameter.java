...
@FacesComponent(value="org.geojsf.component.ViewParameter")
@ListenerFor(systemEventClass=PostAddToViewEvent.class)
public class ViewParameter extends UIComponentBase
{
	final static Logger logger = LoggerFactory.getLogger(ViewParameter.class);
	...
	public void encodeAll(FacesContext ctx) throws IOException
	{
		...
		String command = "<script>GeoJSF.updateViewParams('" +key +"','"+value +"');</script>";
