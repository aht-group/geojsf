...
@DiscriminatorValue("revER")
@EjbErNode(name="Relation",category="revision",subset="revision",level=4)
public class DfRevisionEntityRelation implements JeeslRevisionEntityRelation<DefaultGeoJsfLang,DefaultGeoJsfDescription,DfRevisionEntityRelation,DefaultGeoJsfGraphic>
{
