				...
				implements Serializable
{
	...
	private final XmlNamedLayerFactory<L,D,G,GT,F,FS,SERVICE,LAYER,MAP,SCALE,VIEW,VP,DS,SLDTEMPLATE,SLDTYPE,SLD,RULE> xfNamedLayer;
	
	public XmlStyledLayerDescriptorFactory(final SldConfigurationProvider sldCp)
	{
		xfNamedLayer = new XmlNamedLayerFactory<L,D,G,GT,F,FS,SERVICE,LAYER,MAP,SCALE,VIEW,VP,DS,SLDTEMPLATE,SLDTYPE,SLD,RULE>(sldCp);
	}
