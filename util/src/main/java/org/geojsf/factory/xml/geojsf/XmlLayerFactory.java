...
public class XmlLayerFactory<D extends UtilsDescription> implements Serializable
{
	...
	public <L extends UtilsLang,
		...
		Layer build (GeoJsfLayer<L,D,CATEGORY,SERVICE,LAYER,MAP,VIEW,VP,DS,SLDTYPE,SLDTEMPLATE> ejb)
	{
		Layer xml = new Layer();
	...
	public <L extends UtilsLang,
			...
			SLDTYPE extends UtilsStatus<SLDTYPE,L,D>,
			SLDTEMPLATE extends GeoJsfSldTemplate<L,D,SLDTYPE,SLDTEMPLATE>> 
		Layer build (GeoJsfView<L,D,CATEGORY,SERVICE,LAYER,MAP,VIEW,VP,DS,SLDTYPE,SLDTEMPLATE> ejb)
	{
		Layer xml = new Layer();
