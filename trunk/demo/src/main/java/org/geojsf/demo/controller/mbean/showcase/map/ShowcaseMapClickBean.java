package org.geojsf.demo.controller.mbean.showcase.map;
...
@Named
@SessionScoped
public class ShowcaseMapClickBean implements Serializable {
	
	private static final long serialVersionUID = -4869182190759908416L;
	final static Logger logger = LoggerFactory.getLogger(ShowcaseMapClickBean.class);
	private String text;
